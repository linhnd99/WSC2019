...
namespace WSC2019.Model
{
    ...
    public partial class Session2Entities : DbContext
    {
        ...
        public virtual ObjectResult<SP_GetdgvRequest_Result> SP_GetdgvRequest()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GetdgvRequest_Result>("SP_GetdgvRequest");
        }
    }
}
